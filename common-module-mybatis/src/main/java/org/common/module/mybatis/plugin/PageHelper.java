...
public class PageHelper implements Interceptor {
     ...
     * @return
     */
    public static org.common.module.entity.query.Page getPageResult(List<?> data) {
    	if (data instanceof Page) {
    		Page<?> page = (Page<?>)data;
    		org.common.module.entity.query.Page wrapperPage = new org.common.module.entity.query.Page(page.getPageNum(), page.getPageSize());
